...
When I Knit it, his next line doesn't work for some reason, can't assign
anything to dataset messes up the whole next section, worked when I
first tried it removing the chunks to make the doc actually knit

hp2001Q1$pred.SC &lt;- predict(lm(Structure.Cost ~ log(Land.Value), data
= hp2001Q1)) \#adding a column to the dataset, cost-value

p1 &lt;- ggplot(hp2001Q1, aes(x = log(Land.Value), y = Structure.Cost))
\# creating p1, from the dataset, with x as land, and y as
structurecost,p1 + geom\_point(aes(color = Home.Value)) + geom\_smooth()

p1 + geom\_point(aes(color = Home.Value)) + geom\_line(aes(y = pred.SC))
\#geometric points, assign color based on home value \# assigning the
prediction line to the scatterplot
...
![](exercise-8_files/figure-markdown_strict/unnamed-chunk-15-1.png)
...
![](exercise-8_files/figure-markdown_strict/unnamed-chunk-16-1.png)
...
![](exercise-8_files/figure-markdown_strict/unnamed-chunk-17-1.png)
...
![](exercise-8_files/figure-markdown_strict/unnamed-chunk-18-1.png)
...
![](exercise-8_files/figure-markdown_strict/unnamed-chunk-19-1.png)
\#\#\#\#I.2 color the points blue

    ggplot(dat, aes(x = CPI, y = HDI)) + geom_point(color = "blue")

![](exercise-8_files/figure-markdown_strict/unnamed-chunk-20-1.png)
\#\#\#\#\# I.3 map the color to the region

    ggplot(dat, aes(x = CPI, y = HDI, color)) + geom_point()

![](exercise-8_files/figure-markdown_strict/unnamed-chunk-21-1.png)

    unique(dat$Region)

    ## [1] Asia Pacific      East EU Cemt Asia MENA              SSA              
    ## [5] Americas          EU W. Europe     
    ## 6 Levels: Americas Asia Pacific East EU Cemt Asia EU W. Europe ... SSA

##### I.4 make points bigger by setting size to 2

    ggplot(dat, aes(x = CPI, y = HDI, color = Region)) + geom_point(size=2)

![](exercise-8_files/figure-markdown_strict/unnamed-chunk-23-1.png)
\#\#\#\#\# I.5 Map point to HDI.Rank

    ggplot(dat, aes(x = CPI, y = HDI, color = Region, size = HDI.Rank)) + geom_point()

![](exercise-8_files/figure-markdown_strict/unnamed-chunk-24-1.png)
...
![](exercise-8_files/figure-markdown_strict/unnamed-chunk-26-1.png)

    p2 + geom_histogram(stat = "bin", binwidth = 4000)

![](exercise-8_files/figure-markdown_strict/unnamed-chunk-27-1.png)
...
![](exercise-8_files/figure-markdown_strict/unnamed-chunk-29-1.png) \#\#
Exercise II II.

    ggplot(dat, aes(x = CPI, y = HDI)) + geom_point()

![](exercise-8_files/figure-markdown_strict/unnamed-chunk-30-1.png) II.2

    ggplot(dat, aes(x = CPI, y = HDI)) + geom_point() + geom_smooth()

    ## `geom_smooth()` using method = 'loess'

![](exercise-8_files/figure-markdown_strict/unnamed-chunk-31-1.png) II.3

    ggplot(dat, aes(x = CPI, y = HDI)) + geom_point() + geom_smooth(method = lm)

![](exercise-8_files/figure-markdown_strict/unnamed-chunk-32-1.png) II.4

    ggplot(dat, aes(x = CPI, y = HDI)) + geom_point() + geom_line(stat = "ecdf")

![](exercise-8_files/figure-markdown_strict/unnamed-chunk-33-1.png)
...
![](exercise-8_files/figure-markdown_strict/unnamed-chunk-35-1.png)
...
![](exercise-8_files/figure-markdown_strict/unnamed-chunk-36-1.png)
...
![](exercise-8_files/figure-markdown_strict/unnamed-chunk-37-1.png)
...
![](exercise-8_files/figure-markdown_strict/unnamed-chunk-38-1.png)
III.2
...
![](exercise-8_files/figure-markdown_strict/unnamed-chunk-39-1.png)
...
![](exercise-8_files/figure-markdown_strict/unnamed-chunk-40-1.png)

    p5 <- ggplot(housing, aes(x = Date, y = Home.Value))
    p5 + geom_line(aes(color = State))

![](exercise-8_files/figure-markdown_strict/unnamed-chunk-41-1.png)

    (p5 <- p5 + geom_line() +
       facet_wrap(~State, ncol = 10))

![](exercise-8_files/figure-markdown_strict/unnamed-chunk-42-1.png)

    p5 + theme_linedraw()

![](exercise-8_files/figure-markdown_strict/unnamed-chunk-43-1.png)

    p5 + theme_linedraw()

![](exercise-8_files/figure-markdown_strict/unnamed-chunk-44-1.png)

    p5 + theme_minimal() +
      theme(text = element_text(color = "turquoise"))

![](exercise-8_files/figure-markdown_strict/unnamed-chunk-45-1.png)
...
![](exercise-8_files/figure-markdown_strict/unnamed-chunk-46-1.png)
...
![](exercise-8_files/figure-markdown_strict/unnamed-chunk-47-1.png)
...
![](exercise-8_files/figure-markdown_strict/unnamed-chunk-48-1.png)
...
![](exercise-8_files/figure-markdown_strict/unnamed-chunk-53-1.png)
